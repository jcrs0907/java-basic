...
public class PropertiesApp {
	public static void main(String[] args) throws IOException {
		...
		// => Properties 인스턴스에는 Key와 Value을 하나의 엔트리(Entry)으로 처리하여 저장
		Properties properties=new Properties();
		
		//Properties.load(InputStream in) : Properties 파일에 저장된 모든 Key와 Value을 얻어와
		...
		// => 반환값이 Object 타입으로 반환받므로 반드시 명시적 객체 형변환하여 저장
