...
public class ConsoleIOApp {
	public static void main(String[] args) throws IOException {
		...
		//System.in: Java에서 제공되는 키보드 입력 스트림으로 원시 데이터를 반환하는 기능 제공
		//InputStreamReader: InputStream 인스턴스를 전달받아 입력 스트림을 확정하여 문자
		//데이터 하나를 반환하는 기능을 제공한다.
		//BufferedReader: Reader 인스턴스를 전달받아 입력 스트림을 확장하여
		//대량의 문자 데이터를 반환하는 기능을 제공하는 스트림
		
		BufferedReader in = new BufferedReader(new InputStreamReader(System.in));
		
		
		//System.out: Java에서 제공되는 모니터 출력 스트림으로 원시 데이터 하나를 반환하는 기능을 제공하는 스트림
		//PrintStream 클래스를 이용하여 생성된 출력 스트림
		//print() 또는 println() 메소드를 이용하여 모든 값을 원시 데이터로 변환하여 전달
		...
		//키보드 입력값을 문자열로 반환받아 정수값으로 변환하여 저장한다
