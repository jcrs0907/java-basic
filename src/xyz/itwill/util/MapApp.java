...
// => 키(Key)과 값(Value:인스턴스)를 하나의 쌍(엔트리:Entry)으로 묶어서 관리하는 자료구조 클래스
...
public class MapApp {
	public static void main(String[] args) {
		...
		//Map.toString() : Map 인스턴스에 저장된 모든 엔트리를 문자열로 변환하는 반환하는 메소드
		//System.out.println("map.toString() = "+map.toString());
		System.out.println("map = "+map);
		System.out.println("===========================================================");
		//Map.put() 메소드 호출시 전달된 엔트리의 키가 중복될 경우 엔트리의 값 변경
		map.put(2000, "임걱정");
		System.out.println("map = "+map);
		System.out.println("===========================================================");
