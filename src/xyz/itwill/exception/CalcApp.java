...
public class CalcApp {
	//throws InputMismatchException를 작성하지 않아도 JVM이 처리한다
	...
	public CalcApp() throws InputMismatchException, ArithmeticException{
		...
		//입력값이 정수값으로 변환되지 못할 경우 InputMissMatchException 발생 - 예외 처리
	...
	public static void main(String[] args) {
		...
		try {
			...
			//=> 모든 예외를 전달받아 예외 처리 가장 마지막에 사용해야 한다
		...
		*/
		...
		try {
			...
			//한번에 두가지 에러를 catch 할 수 있지만 에러 메세지를 줄 때 모호하여 사용하지 않는 것이 좋다.
