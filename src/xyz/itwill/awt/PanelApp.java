...
public class PanelApp extends Frame{
	...
	public PanelApp(String title) {
		...
		//Component.setForeground(Color c): 컴퍼넌트의 글자색을 변경하는 메서드
		...
		//Component.setForeground(Color c):컴퍼넌트의 배경색을 변경하는 메소드
		...
		//Component.setEditable(boolean b):텍스트 컴퍼넌트의 텍스트 입력 기능 사용 여부를 설정하기 위한 메서드
		//false: 입력 기능 비활성, true: 입력 기능 활성(기본)
		textarea.setEditable(false);

		
		//Component.setFocusable(boolean b): 컴퍼넌트의 입력 촛점 위치 여부를 설정하기 위한 메서드
