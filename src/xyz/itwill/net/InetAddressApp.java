...
public class InetAddressApp {
	public static void main(String[] args) throws UnknownHostException {
		//InetAddress.getLocalHost() : 로컬 컴퓨터의 네트워크 정보가 저장된 InetAddress 인스턴스를 반환하는 메소드
		// => UnknownHostException 발생 : HostName의 컴퓨터를 검색할 수 없는 경우 발생되는 예외
		// => 현재 컴퓨터는 [127.0.0.1]의 IP Address와 [localhost]의 HostName이 자동 제공
		...
		System.out.println("=============================================================");
		//InetAddress.getByName(String host) : 전달받은 컴퓨터명에 대한 네트워크 정보가
		...
		System.out.println("=============================================================");
		//InetAddress.getAllByName(String host) : 전달받은 컴퓨터명에 대한 네트워크 정보가
		//저장된 InetAddress 인스턴스 배열을 반환하는 메소드
