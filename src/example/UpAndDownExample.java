...
//			}else {
//				if(count < 10) {
//					if(num > randomNum)System.out.println("작은값 입력");
//					if(num < randomNum)System.out.println("큰값 입력");
//				}else if(10 == count) {
//					System.out.println("답" +  randomNum);
//					break;
//				}
//			
//			}
	...
	public static void main(String[] args) {
		...
		for(int i=1; i<=10; i++) {
			...
			if(dap==input) {
				...
				System.out.println("[메세지] "+input+"보다 큰 값을 입력해보세요");
			}else {
				System.out.println("[메세지] "+input+"보다 작은 값을 입력해보세요");
